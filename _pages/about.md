...
​
- **LLM-Generated Text Detection & Benchmarking**: To address the opacity of AI-generated content, I released a systematic survey [Computational Linguistics'24] that highlights the field’s key challenges and future directions. I then developed detection frameworks leveraging grammatical [COLING'25] and representation pattern [TACL'25] differences, constructed leading benchmarks tailored to real-world scenarios [NeurIPS'24] and specialized domains (e.g., modern Chinese poetry [EMNLP'25]), and organized the shared task on this topic [NLPCC'25]. ​
